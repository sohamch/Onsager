...
# Dumbbell representations start below

# Dumbbell state representer class.
class dumbbell(collections.namedtuple('dumbbell', 'iorind R')):
...
# Solute-dumbbell complex state representer class
class SdPair(collections.namedtuple('SdPair', "i_s R_s db")):
    def __eq__(self, other):
        true_class = isinstance(other, self.__class__)
...
# class to represent dumbbell jumps from complex or mixed dumbbell states
class jump(collections.namedtuple('jump', 'state1 state2 c1 c2')):
...
class connector(collections.namedtuple('connector', 'state1 state2')):
    """
...
# Representation objects ready, now create Dumbbell containers
# Dumbbell containers are analogues of "Crystal" class for dumbbells, containing all necessary information
# regarding allowed dumbbell states, symmetry operations and bare dumbbell jump networks
